...
my_words = {'THAT', 'WITH', 'THIS', 'HAVE', 'FROM', 'THEY', 'WILL', 'WHICH', 'WHAT', 'MAKE', 'KNOW', 'TIME', 'THERE', 'YEAR', 'COULD', 'THINK', 'PEOPLE', 'MORE', 'WATER', 'THAN', 'OTHER', 'FIRST', 'MOST', 'LIKE', 'OVER', 'DOWN', 'ONLY', 'INTO', 'GOOD', 'WELL', 'GIVE', 'LIFE', 'SOME', 'BECAUSE', 'YOUR', 'THAN', 'THEN', 'LOOK', 'ONLY', 'COME', 'OVER', 'THINK', 'ALSO', 'BACK', 'AFTER', 'USE', 'TWO', 'HOW', 'WORK', 'FIRST', 'WELL', 'EVEN', 'WANT', 'BECAUSE', 'THESE', 'GIVE', 'MOST', 'WERE', 'HAVE', 'DOES', 'SAYS', 'SAID', 'GOES', 'WENT', 'GONE', 'GETS', 'GOT', 'MAKE', 'MAKES', 'MADE', 'COME', 'COMES', 'CAME', 'SEES', 'SEEN', 'PUTS', 'LETS', 'LEAVE', 'LEAVES', 'LEFT', 'LIKE', 'LIKES', 'LIKED', 'THINK', 'THINKS', 'THOUGHT', 'KNOW', 'KNOWS', 'KNEW', 'KNOWN', 'WANT', 'WANTS', 'WANTED', 'GIVE', 'GIVES', 'GAVE', 'GIVEN', 'FIND', 'FINDS', 'FOUND', 'TELL', 'TELLS', 'TOLD', 'WORK', 'WORKS', 'WORKED', 'CALL', 'CALLS', 'CALLED', 'TRY', 'TRIES', 'TRIED', 'ALICE', 'BOB', 'EVE', 'COMMA', 'WALK', 'VERY', 'WHEN', 'ABOUT'}
